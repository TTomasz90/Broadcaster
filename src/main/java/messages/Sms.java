 ...
 *  SMS class
 *  Author: Tomasz Turek
 *	Description: SMS class contains the implementation of functions governing 
 *	SMS construction and sending via Twillio API.
 *
 */
...
public class Sms extends Messages {
	...
	public String toString() {
		return "Sms [recipientPhoneNumber=" + recipientPhoneNumber + ", senderPhoneNumber=" + senderPhoneNumber
				+ ", message=" + userMessage + "]";
	}
